...
public:
    ...
    h_Employee() : Employee(){};//defaults in a different way(Prof gave us this way)

    h_Employee(string empName, string empNetID);
};

class s_Employee : public Employee {
public:

    s_Employee() : Employee("",""){};//defaults in a different way

    s_Employee(string empName, string empNetID);
};
